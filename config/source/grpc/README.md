...
A gRPC source server should implement the [`Source`](https://github.com/Augustu/go-micro/config/blob/master/source/grpc/proto/grpc.proto#L3L6) proto interface.
