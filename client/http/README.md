...
It complies with the [go-micro.Client](https://godoc.org/github.com/Augustu/go-micro/client#Client) interface.
...
```go
import "github.com/Augustu/go-plugins/client/http"
...
```go
import _ "github.com/Augustu/go-plugins/client/http"
```
